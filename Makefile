...
CY_AFR_BUILD=afr-wifi-bluetooth-tester
...
# Name of application (used to derive name of final linked file).
APPNAME=afr-wifi-bluetooth-tester
...
# added to the build
#
COMPONENTS=FREERTOS PSOC6HAL MBEDTLS LWIP WICED_BLE

ifeq ($(TARGET),CY8CKIT-062S2-43012)
COMPONENTS += 43012 CY8CKIT_062S2_43012
endif

ifeq ($(TARGET),CY8CKIT-062-WIFI-BT)
COMPONENTS += 4343W CY8CKIT_062_WIFI_BT
endif

ifeq ($(TARGET),CY8CPROTO-062-4343W)
COMPONENTS += 4343W CY8CPROTO_062_4343W
endif
...
DEFINES=CYBSP_WIFI_CAPABLE CY_RETARGET_IO_CONVERT_LF_TO_CRLF CY_USE_LWIP MBEDTLS_USER_CONFIG_FILE=\"mbedtls_user_config_afr.h\" MBEDTLS_CONFIG_FILE=\"aws_mbedtls_config.h\" CY_FN_DEFINE

# Control CY_WIFI_HOST_WAKE_SW_FORCE
ifeq ($(CY_WIFI_HOST_WAKE_SW_FORCE),0)
...
CY_IGNORE+= $(CY_AFR_ROOT)/vendors/cypress/MTB/libraries/command-console
